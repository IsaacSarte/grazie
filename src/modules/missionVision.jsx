...
const MissionVision = () => {
  return (
    <div className="bg-[#756666] p-6 h-screen ">
      <div className="flex justify-between items-start">
        <div className="mt-4 text-2xl text-white font-semibold opacity-75">
      ...
      <div className="flex justify-between mt-4">
        <div className="w-full max-w-[600px] h-[550px] m-4">
          <div className="bg-white p-4 rounded h-full">
            ...
            />
            <span className="mt-3 text-[16px] font-semibold opacity-65">
              Mission
            </span>
